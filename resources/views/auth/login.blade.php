        ...
        <div class="col-md-4 login-form">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    <input id="marine_number" type="text" class="form-control  @error('marine_number') is-invalid @enderror" name="marine_number" value="{{ old('marine_number') }}" required autocomplete="off" autofocus placeholder="Marines Serial No." />
                ...
                <div class="row mt-2">
                    <a class="btn btn-link forgtpwd" href="{{ url('/applicants') }}">
                        {{ __('Register Applicant now') }}
                    </a>
                </div>
        </div>
        </form>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <input id="modalTxtMarineNum" type="text" class="form-control" name="modalTxtMarineNum" required autocomplete="off" autofocus placeholder="Marines Serial No." />
                </div>
            </div>
